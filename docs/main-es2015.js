...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<app-archive-task *ngFor=\"let task of tasks; let i = index\" [index]=\"i\" [task]=\"task\" (movedToCurrent)=\"moveTaskToCurrent($event)\" (deleted)=\"deleteTask($event)\"></app-archive-task>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<app-task *ngFor=\"let task of tasks; let i = index\" [task]=\"task\" [index]=\"i\" (deleted)=\"deleteTask($event)\" (stopped)=\"stopTask($event)\"></app-task>");
...
/* harmony import */ var _archive_list_archive_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./archive-list/archive-list.component */ "./src/app/archive-list/archive-list.component.ts");
...
const routes = [
    { path: 'current', component: _task_list_task_list_component__WEBPACK_IMPORTED_MODULE_3__["TaskListComponent"] },
    { path: 'archive', component: _archive_list_archive_list_component__WEBPACK_IMPORTED_MODULE_4__["ArchiveListComponent"] },
...
let AppComponent = class AppComponent {
    constructor(dialog, notifyService) {
        this.dialog = dialog;
    ...
    openCreateDialog() {
        ...
        this.dialog.open(_create_task_create_task_component__WEBPACK_IMPORTED_MODULE_3__["CreateTaskComponent"], { width: '400px' });
        this.searchTerm = '';
        this.search();
    }
    /**
...
/* harmony import */ var _create_task_create_task_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./create-task/create-task.component */ "./src/app/create-task/create-task.component.ts");
/* harmony import */ var _archive_list_archive_list_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./archive-list/archive-list.component */ "./src/app/archive-list/archive-list.component.ts");
/* harmony import */ var _archive_task_archive_task_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./archive-task/archive-task.component */ "./src/app/archive-task/archive-task.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _create_task_create_task_component__WEBPACK_IMPORTED_MODULE_11__["CreateTaskComponent"],
            _archive_list_archive_list_component__WEBPACK_IMPORTED_MODULE_12__["ArchiveListComponent"],
            _archive_task_archive_task_component__WEBPACK_IMPORTED_MODULE_13__["ArchiveTaskComponent"]
        ],
        imports: [
...
let ArchiveListComponent = class ArchiveListComponent {
    constructor(taskService, notifyService) {
        this.taskService = taskService;
        this.notifyService = notifyService;
        // Filter tasks when search has occured.
        notifyService.search.subscribe((searchTerm) => {
            this.pauseAllTasks();
            this.tasks = this.unfilteredTasks.filter((task) => {
                return (task.name.toUpperCase().indexOf(searchTerm.toUpperCase()) !== -1 ||
     ...
     */
    removeTask(id) {
        this.unfilteredTasks = this.unfilteredTasks.filter((val) => val.id !== id);
...
ArchiveListComponent.ctorParameters = () => [
...
ArchiveListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./archive-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/archive-list/archive-list.component.html")).default
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ArchiveTaskComponent", function() { return ArchiveTaskComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let ArchiveTaskComponent = class ArchiveTaskComponent {
    constructor() {
...
], ArchiveTaskComponent.prototype, "task", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ArchiveTaskComponent.prototype, "index", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], ArchiveTaskComponent.prototype, "deleted", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], ArchiveTaskComponent.prototype, "movedToCurrent", void 0);
ArchiveTaskComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-archive-task',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./archive-task.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/archive-task/archive-task.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./archive-task.component.css */ "./src/app/archive-task/archive-task.component.css")).default]
    })
...
let CreateTaskComponent = class CreateTaskComponent {
    constructor(dialogRef, taskService, notifyService, fb) {
     ...
     */
    save(form) {
        this.taskService.getHighestId().subscribe((highestId) => {
            const task = {
                id: highestId + 1,
...
CreateTaskComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./create-task.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/create-task/create-task.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./create-task.component.css */ "./src/app/create-task/create-task.component.css")).default]
    })
], CreateTaskComponent);
...
let TaskService = class TaskService {
     ...
     */
    getTask(id) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(JSON.parse(localStorage.getItem(`time-tracker-${id}`)));
    }
    /**
...
let TaskListComponent = class TaskListComponent {
    constructor(taskService, notifyService) {
        ...
        notifyService.taskAdded.subscribe((task) => {
        ...
        taskService.getCurrentTasks().subscribe((currentTasks) => {
...
let TaskComponent = class TaskComponent {
    constructor(notifyService) {
        ...
        notifyService.taskStarted.subscribe((id) => {
            if (id !== this.task.id) {
                this.pauseTimer();
            }
        });
     ...
     */
    determineDifferenceInTime(dateStarted, currentDate) {
     ...
     */
    increaseTime(dateStarted, timeAlreadyElapsed) {
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], TaskComponent.prototype, "stopped", void 0);
...
module.exports = __webpack_require__(/*! C:\Users\Quartus Kok\Documents\Workspace\Personal\time-tracker\src\main.ts */"./src/main.ts");
